...
function renderReplyLibrary() {
    ...
    if (subTabsContainer) {
        subTabsContainer.innerHTML = `
            ...
            <button class="reply-tab-btn ${currentSubTab === 'emojis' ? 'active' : ''}" data-id="emojis" data-mode="emoji">Emoji</button>
            <button class="reply-tab-btn ${currentSubTab === 'stickers' ? 'active' : ''}" data-id="stickers" data-mode="image">表情库</button>
